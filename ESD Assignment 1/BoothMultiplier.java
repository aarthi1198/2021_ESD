/* Java program to implement a Booth multiplier */
 ...
 class BoothMultiplier
{
    ...
    {
        int[] m = binary(n1);   //multiplicand
        int[] m1 = binary(-n1); //in two's complement notation
        int[] r = binary(n2);   //multiplier    
        int[] A = new int[9];   
        int[] S = new int[9]; 
        int[] P = new int[9];   //Product accumulator
        for (int i = 0; i < 4; i++)
        {
            A[i] = m[i];
            S[i] = m1[i];
    ...
    public static void main (String[] args) 
    {
        ...
        System.out.println("Implementation of Booth's Algorithm\n");
